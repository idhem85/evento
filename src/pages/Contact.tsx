  ...
  return (
    <Layout>
      <div className="container mx-auto py-12 px-4">
        <h1 className="text-4xl font-bold mb-8 text-center">{settings.menuItems[3] || "Contacts"}</h1>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600">{settings.eventLocation}</p>
                </div>
                <div>
